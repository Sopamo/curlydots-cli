...
- TypeScript 5.x (strict) + Bun runtime, Ink, fast-csv, p-limit, zustand (001-push-translations)
- Local filesystem (translation files, auth token store) (001-push-translations)
